...
function Footer() {
  return (
    <div className="w-full flex flex-wrap sm:flex-nowrap gap-2 sm:gap-10 h-[80vh] sm:h-screen py-10 sm:py-16 px-10 sm:px-20 bg-zinc-900 font-['Founders_Grotesk_X_Condensed']">
      <div className=" w-full sm:w-1/2 h-[20vh] sm:h-full pt-8 flex flex-row sm:flex-col justify-between">
        <div className="footertext">
          <h1 className="uppercase text-[9.5vw] font-medium -mb-5 sm:-mb-24">Eye-</h1>
          <h1 className="uppercase text-[9.5vw] font-medium sm:-mb-20">Opening</h1>
        </div>
        <div className="hidden sm:flex svg">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-full sm:w-1/2 h-[60vh] sm:h-full pt-6 sm:pt-8">
        <h1 className="uppercase text-[9vw] font-medium -mb-10 sm:-mb-20">PRESENTATIONS</h1>
        <div className="dets text-[1.5vw] mt-10 flex flex-row sm:flex-col gap-2 font-['Neue_Montreal']">
          {" "}
          <span className="">S:</span>
          {["Facebook", "LinkedIn", "Instagram", "Behance"].map((item, index) => (
            <a className="underline leading-4" key={index} href="#">
              {item}
            </a>
          ))}
        </div>
        <div className="dets text-[1.5vw] mt-3 sm:mt-10 flex flex-row sm:flex-col gap-2 font-['Neue_Montreal']">
          {" "}
